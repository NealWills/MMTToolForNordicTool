...
//
// extension MMTToolForNordicDFUToolUnit: DfuListener {
//
...
////        }
////
////        let error = MMTToolForNordicDFUTool.createError(code: -1, localDescrip: "dfu stop with error: DFU Cancel")
////        resultBlock?(self.unitId, error)
//
////        if self.dfuStage != .dfuStart { return }
////        self.dfuStage = .dfuFailure
////        MMTNordicLog.debug.log("[MMTToolForNordicDFUToolUnit] dfuStopWithError DFU Cancel ")
////        MMTToolForNordicDFUTool.sendDelegateUnitDFUDidEnd(self, error: MMTToolForNordicDFUTool.createError(code: -1, localDescrip: "DFU Cancel"))
////        if let peripheral = self.peripheral {
////            self.manager?.cancelPeripheralConnection(peripheral)
////        }
//    }
...
////        MMTNordicLog.debug.log("[MMTToolForNordicDFUToolUnit] dfuStart")
////        MMTToolForNordicDFUTool.sendDelegateUnitDFUDidBegin(self)
////        MMTToolForNordicDFUTool.share.multiDelegateList.forEach({
////            $0.weakDelegate?.mmtToolForNordicUnitDFUDidBegin(self)
////        })
//    }
//
...
//        self.progressBlock?(self.unitId, self.currentProgress)
////        if self.dfuStage != .dfuStart { return }
////        MMTNordicLog.debug.log("[MMTToolForNordicDFUToolUnit] dfuProgress progress: \(progress) msg: \(msg)")
////        MMTToolForNordicDFUTool.sendDelegateUnitDFUDidChangeProgress(self, progress: progress)
////        MMTToolForNordicDFUTool.share.multiDelegateList.forEach({
////            $0.weakDelegate?.mmtToolForNordicUnitDFUDidChangeProgress(self, progress: progress)
////        })
//    }
//
...
////        MMTNordicLog.debug.log("[MMTToolForNordicDFUToolUnit] dfuComplete")
////        MMTToolForNordicDFUTool.sendDelegateUnitDFUDidEnd(self, error: nil)
////        MMTToolForNordicDFUTool.share.multiDelegateList.forEach({
////            $0.weakDelegate?.mmtToolForNordicUnitDFUDidEnd(self, error: nil)
////        })
//        if let peripheral = self.peripheral {
//            self.manager?.cancelPeripheralConnection(peripheral)
//        }
...
////        if self.dfuStage != .dfuStart { return }
////        self.dfuStage = .dfuFailure
////        MMTNordicLog.debug.log("[MMTToolForNordicDFUToolUnit] dfuStopWithError \(errorMsg) ")
////        MMTToolForNordicDFUTool.sendDelegateUnitDFUDidEnd(self, error: MMTToolForNordicDFUTool.createError(code: -1, localDescrip: errorMsg))
//////        MMTToolForNordicDFUTool.share.multiDelegateList.forEach({
//////            $0.weakDelegate?.mmtToolForNordicUnitDFUDidEnd(self, error: nil)
//////        })
////        if let peripheral = self.peripheral {
